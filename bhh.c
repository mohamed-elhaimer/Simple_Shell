...
/**
 * help_all - possible builtin shellby
 */
void help_all(void)
{
...
/**
 * help_alias - information on the shell command 'alias'
 */
...
/**
 * help_cd - Displays  builtin command 'cd'
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays shell by builtin command 'exit'
 */
void help_exit(void)
{
...
/**
 * help_help - Displays the shell by builtin command 'help'
 */
void help_help(void)
{
